...
if(MSVC)
  ...
  find_package(HDF5 1.10 COMPONENTS C HL REQUIRED NO_MODULE)
  if(USE_HDF5_SHARED_LIBS)
    set(_hdf5_linkage shared)
  else()
    set(_hdf5_linkage static)
  endif()
  set(HDF5_LIBRARIES hdf5::hdf5-${_hdf5_linkage})
  if(NOT TARGET ${HDF5_LIBRARIES})
    message(FATAL_ERROR "Could not find imported target with name ${HDF5_LIBRARIES}")
  endif()
  set(HDF5_HL_LIBRARIES hdf5::hdf5_hl-${_hdf5_linkage})
  if(NOT TARGET ${HDF5_HL_LIBRARIES})
  message(FATAL_ERROR "Could not find imported target with name ${HDF5_HL_LIBRARIES}")
endif()
else()
...
if(BUILD_python)
  ...
  if(PYTHONLIBS_FOUND AND NUMPY_FOUND AND Boost_PYTHON_FOUND)
    ...
    if(MSVC AND PYTHON_DEBUG_LIBRARY)
      # if the debug library was found we need to link to it instead
      # of linking to the release library
      list(APPEND Caffe_DEFINITIONS PUBLIC -DBOOST_DEBUG_PYTHON)
    endif()
