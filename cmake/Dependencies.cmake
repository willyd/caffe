...
if(MSVC)
  ...
  if(BUILD_SHARED_LIBS)
    set(_hdf5_linkage shared static)
  else()
    set(_hdf5_linkage static shared)
  endif()
  foreach(_linkage ${_hdf5_linkage})
    if(NOT DEFINED HDF5_LIBRARIES AND TARGET hdf5-${_linkage})
      set(HDF5_LIBRARIES hdf5-${_linkage})
    endif()
    if(NOT DEFINED HDF5_HL_LIBRARIES AND TARGET hdf5_hl-${_linkage})
      set(HDF5_HL_LIBRARIES hdf5_hl-${_linkage})
    endif()
  endforeach()
else()
